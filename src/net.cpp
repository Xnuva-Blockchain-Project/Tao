...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TaoCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"demomanca.com", "node.demomanca.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TaoCoin is probably already running."), addrBind.ToString().c_str());
        else
