...
public:
    ...
    {
        // TAO Revival predates SegWit/Bech32/Taproot. Do not create a new
        // address family during the mechanical migration.
        (void)id;
        return {};
    }
...
CTxDestination DecodeDestination(const std::string& str, const CChainParams& params, std::string& error_str, std::vector<int>* error_locations)
{
    ...
    // TAO Revival supports Base58 destinations only. Do not reinterpret any
    // Bech32/Bech32m string as a TAO address in this migration.
    if (is_bech32) {
        error_str = "TAO Revival does not support Bech32 or Bech32m destinations.";
        return CNoDestination();
    }
